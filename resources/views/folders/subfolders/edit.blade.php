...
<form method="POST" action="{{ route('folders.subfolders.update', $subfolder) }}">
    ...
    <div class="card">
        ...
        <textarea name="auto_keywords" id="auto_keywords" rows="3" placeholder="e.g. Service Agreement, SA, SVC-AGR" style="width:100%; padding:10px;">{{ old('auto_keywords', $subfolder->auto_keywords) }}</textarea>
        <p style="margin:8px 0 0; color:#64748b; font-size:0.9rem;">
            ...
            The folder name is always included automatically.
        </p>
