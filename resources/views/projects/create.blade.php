    ...
    <form method="POST" action="{{ route('projects.store') }}">
        ...
        <div class="project-form-grid">
            ...
            <div class="card">
                ...
                <input type="email" name="project_manager_email" id="project_manager_email" value="{{ old('project_manager_email') }}" placeholder="Enter project manager email">
            </div>
            ...
            <div class="card full-width">
                ...
                <input type="email" name="document_controller_email" id="document_controller_email" value="{{ old('document_controller_email') }}" placeholder="Enter document controller email">
            </div>
        </div>
