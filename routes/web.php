...
use App\Http\Controllers\EntityWorkspaceController;
...
Route::middleware(['auth', 'entity.require'])->group(function () {
    Route::get('/workspace', [EntityWorkspaceController::class, 'show'])->name('workspace');

    Route::get('/summary-dashboard', [SummaryDashboardController::class, 'index'])->name('summary-dashboard');
    Route::get('/summary-dashboard/download', [SummaryDashboardController::class, 'download'])->name('summary-dashboard.download');
});
